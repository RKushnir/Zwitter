module Authentication
  ...
  self.login_regex       = /\A[a-zA-Z0-9\.\-_@]+\z/                     # ASCII, strict
  # self.login_regex       = /\A[[:alnum:]][[:alnum:]\.\-_@]+\z/     # Unicode, strict
  # self.login_regex       = /\A[^[:cntrl:]\\<>\/&]*\z/              # Unicode, permissive

  self.bad_login_message = "може містити лише латинські літери, цифри і символи .-_@".freeze
  ...
  self.bad_email_message = "повинен виглядати як адреса е-мейл".freeze
